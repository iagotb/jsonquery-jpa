...
INSERT IGNORE INTO `thing` (`id`, `name`) VALUES
(1, 'Paper'),
(2, 'Pen'),
(3, 'Pencil'),
(4, 'Ballpen');
...
INSERT IGNORE INTO `parent` (`id`, `store`, `thing_id`) VALUES
(1, 'StoreA', 1),
(2, 'StoreB', 2),
(3, 'StoreC', 3),
(4, 'StoreD', 4);
...
INSERT IGNORE INTO `child` (`id`, `age`, `birthDate`, `creationDate`, `money`, `name`, `parent_id`, `married`) VALUES
