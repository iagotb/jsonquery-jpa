...
public class JsonBooleanBuilderOrTest {
	...
	"{\"junction\":\"or\",\"field\":\"money\",\"op\":\"lt\",\"data\":\"2000.75\"}," +
	"{\"junction\":\"or\",\"field\":\"birthDate\",\"op\":\"eq\",\"data\":\"1959-09-30T00:00:00.000Z\"}," +
	"{\"junction\":\"or\",\"field\":\"parent.id\",\"op\":\"eq\",\"data\":\"2\"}," +
	"{\"junction\":\"or\",\"field\":\"creationDate\",\"op\":\"eq\",\"data\":\"01-31-1980 +5\"}" +
	"]}";
	...
	@Test
	public void testBuild_Long_Eq_Beginning() throws ParseException {
		PathBuilder<Child> entityPath = new PathBuilder<Child>(Child.class, "child");
		NumberPath<Long> path = entityPath.get( new NumberPath<Long>(Long.class, "id") );
		BooleanBuilder builder1 = new BooleanBuilder();
		builder1.and(path.eq( Long.valueOf("1") ));
	...
	public void testBuild() {
		BooleanBuilder builder2 = jsonBooleanBuilder.build(new JsonFilter(filterMultiple));
		
		Assert.assertEquals("child.id = 1 || startsWith(child.name,Jane Adams) || child.age > 20 || child.money < 2000.75 || child.birthDate = 1959-09-30T00:00:00.000+08:00 || child.parent.id = 2 || child.creationDate = Fri Nov 30 00:00:00 PHT 8", builder2.toString());
	}
}
